...
contract DividendInTokenEnabledToken is BaseToken{
    ...
    function disburse(uint256 _value) internal onlyWhenTokenIsOn  {
        require(_value >0);
        totalDividendPoints = totalDividendPoints.add((_value.mul(pointsMultiplier)).div(totalSupply));
